...
#define ETH_ADDR_1 0  //1
#define ETH_MDC_PIN_1 23
#define ETH_MDIO_PIN_1 18
//ESP32 PINS TO CONTROL CC2652P
#define CC2652P_RST 15 //33
#define CC2652P_FLSH 2//32
#define CC2652P_RXD 17
#define CC2652P_TXD 5
#define BTN 33//35
#define MODE_SWITCH 13//4
...
struct ConfigSettingsStruct{
  ...
  bool hasPOE;// for model luw02p,luw03p
  bool powerPOE;//powersupply true=poe   for model luw02p,luw03p
  bool powerUSB; //for model luw02p,luw03p
};
...
#define modelID "GW_Z_LUW02P"
//void hasPOE(String idName) true=poe,false=none poe
